...
import { createEmptyDraft, draftSchema, type Draft } from "../src/types";
import { legacyDraftSchema, legacyQuestions, legacyScore } from "../src/legacy";
import { calculateRating, readinessLevel, type ReadinessLevel } from "../src/rating";
...
const storeBaseSchema = z.object({
  schemaVersion: z.literal(3), businesses: z.array(businessSchema), teams: z.array(teamSchema),
